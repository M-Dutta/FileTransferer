...
def receiver(connection):
    ...
    com_time = compileReceived(parts, files) 
    print('Time Including Compile: ', et-st+ com_time)
    f1 = open('dataFile.txt','a')
    f2 = open('dataFile2.txt','a')
    f1.write(str(thread_count)+','+str(SIZE)+','+str(et-st)+','+ str(com_time)+'\n')
    f2.write(str(thread_count)+','+str(SIZE)+','+str(et-st)+','+ str(com_time+)',\n')
    f1.close()
    f2.close()
